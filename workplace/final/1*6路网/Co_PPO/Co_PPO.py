...
from flow.envs.multiagent.coopenv import CustomEnv,CustomSEUPressEnv,CustomSEUYellowPressEnv,CustomSEUSinglePressEnv,CustomSEUPress_cav_light_Env
...
flow_params = dict(
    ...
    env_name=CustomSEUPress_cav_light_Env,
