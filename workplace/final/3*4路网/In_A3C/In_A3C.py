...
from flow.envs.multiagent.coopenv import CustomSEUPressEnv
...
def setup_exps():
    ...
    POLICY_GRAPHS = {'cav': (A3CTFPolicy, obs_space_av, act_space_av, {}),
                     'tl': (A3CTFPolicy, obs_space_tl, act_space_tl, {})}
