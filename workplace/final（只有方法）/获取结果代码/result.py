...
def getResults(PATH):
    ...
    print("车辆平均行驶时间：",TT)
    print("车辆平均延误：",DELAY)
    print("车辆可能碰撞平均时间：", COLLISION)
    print("车辆平均燃油消耗：",FUEL)
    print("车辆CO2平均排放量：", CO2CO2)
    ...
    print("**********************最后结果********************************")
    print("车辆平均速度：", mean_VV, "m/s")
    print("车辆平均行驶时间：", mean_TT, "s/km")
    print("车辆平均延误：", mean_DELAY, "s/km")
    print("车辆可能碰撞平均时间：", mean_COLLISION, "s/km")
    print("车辆平均燃油消耗：", mean_FUEL, "L/100km")
    print("车辆CO2平均排放量：", mean_CO2CO2, "g/km")
...
PATHS=["1*1路网/baseline","1*1路网/Co_PPO","1*1路网/fixedtime_cav","1*1路网/In_PPO","1*1路网/RL_HV",
       "1*6路网/baseline","1*6路网/Co_PPO","1*6路网/fixedtime_cav","1*6路网/In_PPO","1*6路网/RL_HV",
       "3*4路网/baseline","3*4路网/Co_PPO","3*4路网/fixedtime_cav","3*4路网/In_PPO","3*4路网/RL_HV",]
sys.stdout = Logger(filename="/home/g/software/pycharm/projects/flow-SEU/workplace/final/" + 'result.txt',
                    stream=sys.stdout)
for PATH in PATHS:
    getResults(PATH)
