...
EDGE_INFLOW = 200  # inflow rate of vehicles at every edge
...
flow_params = dict(
    ...
    env_name=MultiTrafficLightGridSEUSinglePressEnv,
    ...
    sim=SumoParams(
        ...
        # emission_path="data/grid_0_{}x{}_i{}_multiagent".format(N_ROWS, N_COLUMNS, EDGE_INFLOW),
    ),
